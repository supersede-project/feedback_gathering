...
export const applicationId = 31;
export const applicationName = 'Siemens Aspern Energie Dashboard';
export const feedbackObjectTitle = 'Feedback Siemens Aspern Energie Dashboard';
