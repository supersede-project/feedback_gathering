...
class FeedbackForumCommentView extends Component {
  ...
  render()
  {
    return (<div><ForumCommentTitle className="forumComment" title={this.props.post.textFeedbacks[0].text} type={this.props.post.categoryFeedbacks[0].mechanismId} /><CommentUI/></div>);
  }
}
