...
import monitoring.model.TwitterParserConfiguration;

@Path("configuration")
@Singleton
public class TwitterToolDispatcher {
	
	final static Logger logger = Logger.getLogger(TwitterToolDispatcher.class);
	
	private ToolDispatcher toolDispatcher = 
			new ToolDispatcher(new TwitterParserConfiguration(), "SocialNetworksMonitoringConfProfResult");
