...
abstract class AbstractFeedbackDatabase {
    ...
    private String[] collectTableRestoration() {
        return new String[]{
                INSERT_INTO + NumberTableEntry.TABLE_NAME + BRACES_OPEN + NumberTableEntry._ID + COMMA_SEP + NumberTableEntry.COLUMN_NAME_KEY + COMMA_SEP +
                        NumberTableEntry.COLUMN_NAME_VALUE + COMMA_SEP + NumberTableEntry.COLUMN_NAME_TIMESTAMP + BRACES_CLOSE + SUB_SELECT + NumberTableEntry._ID + COMMA_SEP + NumberTableEntry
                        .COLUMN_NAME_KEY + COMMA_SEP +
                ...
                INSERT_INTO + TextTableEntry.TABLE_NAME + BRACES_OPEN + TextTableEntry._ID + COMMA_SEP + TextTableEntry.COLUMN_NAME_KEY + COMMA_SEP +
                        TextTableEntry.COLUMN_NAME_VALUE + COMMA_SEP + TextTableEntry.COLUMN_NAME_TIMESTAMP + BRACES_CLOSE + SUB_SELECT + TextTableEntry._ID + COMMA_SEP + TextTableEntry
                        .COLUMN_NAME_KEY + COMMA_SEP +
                ...
                INSERT_INTO + DataTableEntry.TABLE_NAME + BRACES_OPEN + DataTableEntry._ID + COMMA_SEP + DataTableEntry.COLUMN_NAME_KEY + COMMA_SEP +
                        NumberTableEntry.COLUMN_NAME_VALUE + COMMA_SEP + DataTableEntry.COLUMN_NAME_TIMESTAMP + BRACES_CLOSE + SUB_SELECT + DataTableEntry._ID + COMMA_SEP + DataTableEntry
                        .COLUMN_NAME_KEY + COMMA_SEP +
    ...
    protected class FeedbackDbHelper extends SQLiteOpenHelper {
        ...
        FeedbackDbHelper(Context context) {
            super(context, Environment.getExternalStorageDirectory() + File.separator + FILE_DIR + File.separator + context
                    .getSharedPreferences(SHARED_PREFERENCES_ID, MODE_PRIVATE)
                    .getString(SHARED_PREFERENCES_HOST_APPLICATION_NAME, "") + DATABASE_NAME + DATABASE_ENDING, null, DATABASE_VERSION);
