...
public class Constants {
    ...
    public static class AnnotateImageConstants {
        private AnnotateImageConstants() {
        }
    ...
    public static class OrchestratorConstants {
        ...
        public static final String AUDIO_TITLE_VALUE = "Audio-AbstractMechanism";
        ...
        public static final String TEXT_TITLE_VALUE = "Text-AbstractMechanism";
        ...
        public static final String CATEGORY_TITLE_VALUE = "Screenshot-AbstractMechanism";
