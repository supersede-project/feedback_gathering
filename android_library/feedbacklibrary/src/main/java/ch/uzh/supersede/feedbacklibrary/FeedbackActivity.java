...
public class FeedbackActivity extends AppCompatActivity implements ScreenshotMechanismView.OnImageChangedListener, AudioMechanismView.MultipleAudioMechanismsListener {
    ...
    private static final int REQUEST_ANNOTATE = 12;

    private static final int PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE = 100; // Storage permission (android.permission-group.STORAGE)
            ...
            if (mechanism != null && mechanism.isActive()) {
                ...
                switch (mechanism.getType()) {
                    ...
                    case Mechanism.TEXT_TYPE:
                        ...
                        break;
                    default:
                        Log.e(TAG, "Unknown mechanism type '" + mechanism.getType() + "'");
                        break;
                }

                if (mechanismView != null && mechanismView.getEnclosingLayout() != null) {
                    mechanismViews.add(mechanismView);
                    linearLayout.addView(mechanismView.getEnclosingLayout());
                }
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!isPush && selectedPullConfigurationIndex != -1 && jsonString != null) {
            ...
            init(intent.getLongExtra(Constants.EXTRA_KEY_APPLICATION_ID, -1L), baseURL, language);
        }
    }
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        switch (requestCode) {
            case PERMISSIONS_REQUEST_READ_EXTERNAL_STORAGE:
                ...
                break;
            case Constants.PERMISSIONS_REQUEST_RECORD_AUDIO:
                if (grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
