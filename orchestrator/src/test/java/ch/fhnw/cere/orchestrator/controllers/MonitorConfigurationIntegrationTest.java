...
public class MonitorConfigurationIntegrationTest extends BaseIntegrationTest {
    ...
    public void setUp() throws Exception {
        ...
        this.monitorConfiguration1 = monitorConfigurationRepository.save(new MonitorConfiguration(monitorTool1, 1, "WP4", "Sat June 08 02:16:57 2016", "500", "http://localhost:9092", "olympicGamesTwitterMonitoring", "active", "keyword1 AND keyword2", null, null));
        this.monitorConfiguration2 = monitorConfigurationRepository.save(new MonitorConfiguration(monitorTool1, 1, "manual", "Sat June 08 02:16:57 2016", "304", "http://localhost:9092", "ignoreMe", "active", "keyword4 AND keyword AND keyword5", null, null));
    }
    ...
    public void createMonitorConfigurationUnauthorized() throws Exception {
        MonitorConfiguration monitorConfiguration = new MonitorConfiguration(monitorTool1, 1, "sender", "Sat June 08 02:16:57 2017", "100", "http://localhost:9092", "ignoreMeAgain", "active", "keyword44 AND keyword AND keyword55", null, null);
