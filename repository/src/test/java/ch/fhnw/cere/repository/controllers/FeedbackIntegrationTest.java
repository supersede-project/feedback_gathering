...
public class FeedbackIntegrationTest extends BaseIntegrationTest {
    ...
    public void setup() throws Exception {
        ...
        feedback1 = feedbackRepository.save(new Feedback("Feedback 1 App 1", "userId1", 1, 11, "en", 0, 0, 0, 0));
        feedback2 = feedbackRepository.save(new Feedback("Feedback 2 App 1", "userId2", 1, 11, "it", 0, 0, 0, 0));
        feedback3 = feedbackRepository.save(new Feedback("Feedback 3 App 2", "userId3", 2, 22, "de", 0, 0, 0, 0));

        feedback4 = feedbackRepository.save(new Feedback("Feedback 4 App 20", "userId1", 20, 39, "en", 0, 0, 0, 0));
        feedback5 = feedbackRepository.save(new Feedback("Feedback 5 App 20", "userId2", 20, 39, "it", 0, 0, 0, 0));
    ...
    public void postFeedback() throws Exception {
        Feedback feedback = new Feedback("New Feedback", "userId1", 1, 11, "en", 0, 0, 0, 0);
