...
public class FeedbackEmailServiceTest {
    ...
    public void sendMail() throws IOException, TemplateException {
        Feedback feedback = new Feedback("Test feedback", "userId3", applicationId, 39, "en", commentCount, likeCount, dislikeCount, unreadCommentCount);
        ...
        ContextInformation contextInformation = new ContextInformation(feedback, "2500x1200", "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_3) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/58.0.3029.110 Safari/537.36", null, null, "+0200", 2.0f, null, null, "http://example.com/subpage/path", "{\"diagram\": \"diagramX2\"}");
