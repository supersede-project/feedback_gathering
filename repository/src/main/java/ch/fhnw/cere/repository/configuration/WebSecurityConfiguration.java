...
//                .antMatchers("/feedback_repository/feedback_repository/en/applications/20/feedbacks").permitAll()
//                .requestMatchers(new RegexRequestMatcher("/\\w{2}/applications/\\d+/feedbacks/?", "POST", true)).permitAll()
//                .requestMatchers(new RegexRequestMatcher("/\\w{2}/applications/\\d+/feedbacks/feedbacksettings/?", "POST", true)).permitAll()
